...
Run: model `gpt-4.1`, git head `40fd5796e99ac0fbf81f21f7d74ee9fb56f793a6`, frozen commits ['39a698e5e79a5b6eddebf090caa3f6c8a1b16f7b'], updated 2026-09-11T11:54:10+00:00.<!-- manifest.json -->
Provenance: every number below is followed by an HTML comment `<!-- file#json.path -->`; relative files resolve inside `eval/runs/20260911T113543Z-vitals-no-avoidwhen`.
...
| Must-have target recall | 71.0%<!-- metrics.json#arms.A.target_recall_must_have.recall --> | 65.7%<!-- metrics.json#arms.B.target_recall_must_have.recall --> | 71.3%<!-- metrics.json#arms.C.target_recall_must_have.recall --> |
| &nbsp;&nbsp;must-have recall [quantified] | 74.4%<!-- metrics.json#arms.A.target_recall_must_have.strata.quantified.recall --> | 66.7%<!-- metrics.json#arms.B.target_recall_must_have.strata.quantified.recall --> | 72.6%<!-- metrics.json#arms.C.target_recall_must_have.strata.quantified.recall --> |
| &nbsp;&nbsp;must-have recall [not_quantified] | 85.7%<!-- metrics.json#arms.A.target_recall_must_have.strata.not_quantified.recall --> | 88.1%<!-- metrics.json#arms.B.target_recall_must_have.strata.not_quantified.recall --> | 69.0%<!-- metrics.json#arms.C.target_recall_must_have.strata.not_quantified.recall --> |
...
| Target recall (all) | 53.7%<!-- metrics.json#arms.A.target_recall_all.recall --> | 51.2%<!-- metrics.json#arms.B.target_recall_all.recall --> | 62.3%<!-- metrics.json#arms.C.target_recall_all.recall --> |
...
| Perturbation responsiveness | 69.4%<!-- metrics.json#arms.A.perturbation_responsiveness.rate --> | 63.4%<!-- metrics.json#arms.B.perturbation_responsiveness.rate --> | 53.2%<!-- metrics.json#arms.C.perturbation_responsiveness.rate --> |
| Noise stability (Jaccard) | 0.73<!-- metrics.json#arms.A.noise_stability.jaccard_mean --> | 0.83<!-- metrics.json#arms.B.noise_stability.jaccard_mean --> | 0.10<!-- metrics.json#arms.C.noise_stability.jaccard_mean --> |
...
| should_not_recommend case hit rate | 2.8%<!-- metrics.json#arms.A.should_not_recommend.case_hit_rate --> | 2.8%<!-- metrics.json#arms.B.should_not_recommend.case_hit_rate --> | 13.0%<!-- metrics.json#arms.C.should_not_recommend.case_hit_rate --> |
...
- Must-have recall A 71.0%<!-- metrics.json#arms.A.target_recall_must_have.recall --> vs B 65.7%<!-- metrics.json#arms.B.target_recall_must_have.recall -->.
...
- Noise stability A 0.73<!-- metrics.json#arms.A.noise_stability.jaccard_mean --> vs B 0.83<!-- metrics.json#arms.B.noise_stability.jaccard_mean -->.
...
| Items per case (mean) | 6.056 | 7.759 | 28.694 |
...
| Target recall must_have | 71.0% | 65.7% | 71.3% |
|   must_have recall [quantified] (n) | 74.4% (234) | 66.7% (234) | 72.6% (234) |
|   must_have recall [not_quantified] (n) | 85.7% (42) | 88.1% (42) | 69.0% (42) |
|   must_have recall [unmapped] (n) | 18.5% (27) | 22.2% (27) | 63.0% (27) |
| Target recall all | 53.7% | 51.2% | 62.3% |
...
| Perturbation responsiveness | 69.4% | 63.4% | 53.2% |
|   pairs explicit / fallback | 36 / 0 | 36 / 0 | 36 / 0 |
| Noise stability (Jaccard mean) | 0.733 | 0.834 | 0.095 |
